                        ...
                        <div className="flex items-center gap-3 flex-1">
                          ...
                          <div className="flex-1">
                            <p className="text-[#2D1B69]">
                              <span className="sm:hidden">{formatDate(payment.date)}</span>
                              <span className="hidden sm:inline">{formatDateLong(payment.date)}</span>
                              {isPostponed && ' 🙏'}
                            </p>
                            {isOverdue && (
                            ...
                            {isPostponed && (
                              <p className="text-[#4A148C]">
                                <span className="sm:hidden">Перенесен с {formatDate(payment.originalDate!)}</span>
                                <span className="hidden sm:inline">Перенесен с {formatDateLong(payment.originalDate!)}</span>
                              </p>
                            )}
