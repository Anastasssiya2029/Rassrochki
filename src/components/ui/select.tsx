...
>(({ className, size = "default", children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    data-size={size}
    className={cn(
      "border-gray-300 bg-white text-gray-900 data-[placeholder]:text-gray-500 focus-visible:border-purple-500 focus-visible:ring-purple-500/30 flex w-full items-center justify-between gap-2 rounded-md border px-3 py-2 text-sm whitespace-nowrap transition-all outline-none focus-visible:ring-2 disabled:cursor-not-allowed disabled:opacity-50 cursor-pointer hover:border-gray-400 data-[size=default]:h-9 data-[size=sm]:h-8 *:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-2 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
      className,
    )}
    {...props}
  >
